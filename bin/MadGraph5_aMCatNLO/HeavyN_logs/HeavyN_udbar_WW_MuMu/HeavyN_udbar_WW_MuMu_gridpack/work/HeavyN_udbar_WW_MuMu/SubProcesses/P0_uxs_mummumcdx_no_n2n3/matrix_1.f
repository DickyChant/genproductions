...
C     
C     Process: u~ s > mu- mu- c d~ g QCD<=1 QED<=4 WEIGHTED<=9 [ all =
C      QCD ] $$ w+ w- / n2 n3
C     Process: c~ d > mu- mu- u s~ g QCD<=1 QED<=4 WEIGHTED<=9 [ all =
C      QCD ] $$ w+ w- / n2 n3
C     
      IMPLICIT NONE
C     
...
C     Amplitude(s) for diagram number 4
      ...
      CALL FFV2_3(W(1,6),W(1,8),GC_24,MDL_MW,MDL_WW,W(1,5))
...
C     Amplitude(s) for diagram number 6
      ...
      CALL FFV1_2(W(1,6),W(1,7),GC_11,ZERO,ZERO,W(1,5))
