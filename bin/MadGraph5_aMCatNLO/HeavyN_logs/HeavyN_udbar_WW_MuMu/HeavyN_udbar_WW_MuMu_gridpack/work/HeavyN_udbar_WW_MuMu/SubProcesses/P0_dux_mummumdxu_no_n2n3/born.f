...
C     
C     Process: d u~ > mu- mu- d~ u QCD=0 QED<=4 [ all = QCD ] $$ w+ w-
C      / n2 n3
C     Process: s c~ > mu- mu- s~ c QCD=0 QED<=4 [ all = QCD ] $$ w+ w-
C      / n2 n3
C     
      IMPLICIT NONE
C     
      ...
      DO IHEL=BACK_HEL,-BACK_HEL,STEP_HEL
        ...
        IF (COND_IJ) THEN
          ...
          IF (.NOT. CALCULATEDBORN) THEN
            ...
            CALL FFV2C1_2(W(1,3),W(1,7),GC_79,MDL_MN1,MDL_WN1,W(1,5))
C           Amplitude(s) for diagram number 1
            CALL FFV2_0(W(1,5),W(1,4),W(1,6),GC_79,AMP(1))
            CALL FFV2_1(W(1,4),W(1,7),GC_79,MDL_MN1,MDL_WN1,W(1,5))
C           Amplitude(s) for diagram number 2
            CALL FFV2C1_0(W(1,3),W(1,5),W(1,6),GC_79,AMP(2))
            DO I=1,NGRAPHS
