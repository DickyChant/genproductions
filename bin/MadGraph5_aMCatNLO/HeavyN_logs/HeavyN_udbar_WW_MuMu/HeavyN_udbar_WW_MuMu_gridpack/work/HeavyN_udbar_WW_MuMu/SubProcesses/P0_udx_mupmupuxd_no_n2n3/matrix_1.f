...
C     
C     Process: u d~ > mu+ mu+ u~ d g QCD<=1 QED<=4 WEIGHTED<=9 [ all =
C      QCD ] $$ w+ w- / n2 n3
C     Process: c s~ > mu+ mu+ c~ s g QCD<=1 QED<=4 WEIGHTED<=9 [ all =
C      QCD ] $$ w+ w- / n2 n3
C     
      IMPLICIT NONE
C     
...
C     Amplitude(s) for diagram number 2
      CALL FFV2C1_0(W(1,9),W(1,3),W(1,11),GC_79,AMP(2))
...
C     Amplitude(s) for diagram number 4
      CALL FFV2C1_0(W(1,9),W(1,3),W(1,8),GC_79,AMP(4))
...
C     Amplitude(s) for diagram number 5
      CALL FFV2_0(W(1,4),W(1,8),W(1,5),GC_79,AMP(5))
      CALL FFV2_2(W(1,4),W(1,9),GC_79,MDL_MN1,MDL_WN1,W(1,2))
C     Amplitude(s) for diagram number 6
      CALL FFV2C1_0(W(1,2),W(1,3),W(1,5),GC_79,AMP(6))
...
C     Amplitude(s) for diagram number 8
      CALL FFV2C1_0(W(1,2),W(1,3),W(1,7),GC_79,AMP(8))
