...
C     
C     Process: d g > mu- mu- d~ u u QCD<=1 QED<=4 WEIGHTED<=9 [ all =
C      QCD ] $$ w+ w- / n2 n3
C     Process: s g > mu- mu- s~ c c QCD<=1 QED<=4 WEIGHTED<=9 [ all =
C      QCD ] $$ w+ w- / n2 n3
C     
      IMPLICIT NONE
C     
...
C     ----------
      ...
      CALL FFV1_2(W(1,5),W(1,2),GC_11,ZERO,ZERO,W(1,9))
      CALL FFV2C1_2(W(1,3),W(1,8),GC_79,MDL_MN1,MDL_WN1,W(1,10))
      CALL FFV2_3(W(1,9),W(1,7),GC_24,MDL_MW,MDL_WW,W(1,11))
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV1_1(W(1,7),W(1,2),GC_11,ZERO,ZERO,W(1,11))
      CALL FFV2_3(W(1,5),W(1,11),GC_24,MDL_MW,MDL_WW,W(1,8))
C     Amplitude(s) for diagram number 3
      CALL FFV2_0(W(1,10),W(1,4),W(1,8),GC_79,AMP(3))
C     Amplitude(s) for diagram number 4
      CALL FFV2C1_0(W(1,3),W(1,12),W(1,8),GC_79,AMP(4))
      CALL FFV2_3(W(1,1),W(1,7),GC_24,MDL_MW,MDL_WW,W(1,8))
      CALL FFV2C1_2(W(1,3),W(1,8),GC_79,MDL_MN1,MDL_WN1,W(1,7))
      CALL FFV2_3(W(1,9),W(1,6),GC_24,MDL_MW,MDL_WW,W(1,1))
C     Amplitude(s) for diagram number 5
      CALL FFV2_0(W(1,7),W(1,4),W(1,1),GC_79,AMP(5))
      CALL FFV2_1(W(1,4),W(1,8),GC_79,MDL_MN1,MDL_WN1,W(1,9))
C     Amplitude(s) for diagram number 6
      CALL FFV2C1_0(W(1,3),W(1,9),W(1,1),GC_79,AMP(6))
      CALL FFV1_1(W(1,6),W(1,2),GC_11,ZERO,ZERO,W(1,1))
      CALL FFV2_3(W(1,5),W(1,1),GC_24,MDL_MW,MDL_WW,W(1,6))
C     Amplitude(s) for diagram number 7
      CALL FFV2_0(W(1,7),W(1,4),W(1,6),GC_79,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV2C1_0(W(1,3),W(1,9),W(1,6),GC_79,AMP(8))
      JAMP(1)=+AMP(5)+AMP(6)+AMP(7)+AMP(8)
      JAMP(2)=-AMP(1)-AMP(2)-AMP(3)-AMP(4)
      MATRIX_3 = 0.D0
      DO I = 1, NCOLOR
        ZTEMP = (0.D0,0.D0)
        DO J = 1, NCOLOR
