...
C     
C     Process: u~ g > mu- mu- c d~ s~ QCD<=1 QED<=4 WEIGHTED<=9 [ all
C      = QCD ] $$ w+ w- / n2 n3
C     Process: c~ g > mu- mu- u s~ d~ QCD<=1 QED<=4 WEIGHTED<=9 [ all
C      = QCD ] $$ w+ w- / n2 n3
C     
      IMPLICIT NONE
C     
...
C     ----------
      ...
      CALL FFV2C1_2(W(1,3),W(1,8),GC_79,MDL_MN1,MDL_WN1,W(1,1))
      CALL FFV2_3(W(1,7),W(1,6),GC_24,MDL_MW,MDL_WW,W(1,9))
C     Amplitude(s) for diagram number 1
      CALL FFV2_0(W(1,1),W(1,4),W(1,9),GC_79,AMP(1))
      CALL FFV2_1(W(1,4),W(1,8),GC_79,MDL_MN1,MDL_WN1,W(1,6))
C     Amplitude(s) for diagram number 2
      CALL FFV2C1_0(W(1,3),W(1,6),W(1,9),GC_79,AMP(2))
      CALL FFV1_2(W(1,7),W(1,2),GC_11,ZERO,ZERO,W(1,9))
      CALL FFV2_3(W(1,9),W(1,5),GC_24,MDL_MW,MDL_WW,W(1,7))
C     Amplitude(s) for diagram number 3
      CALL FFV2_0(W(1,1),W(1,4),W(1,7),GC_79,AMP(3))
C     Amplitude(s) for diagram number 4
      CALL FFV2C1_0(W(1,3),W(1,6),W(1,7),GC_79,AMP(4))
