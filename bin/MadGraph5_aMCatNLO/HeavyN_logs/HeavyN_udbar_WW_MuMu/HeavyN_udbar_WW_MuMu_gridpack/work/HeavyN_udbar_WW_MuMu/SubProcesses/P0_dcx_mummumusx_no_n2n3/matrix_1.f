...
C     
C     Process: d c~ > mu- mu- u s~ g QCD<=1 QED<=4 WEIGHTED<=9 [ all =
C      QCD ] $$ w+ w- / n2 n3
C     Process: s u~ > mu- mu- c d~ g QCD<=1 QED<=4 WEIGHTED<=9 [ all =
C      QCD ] $$ w+ w- / n2 n3
C     
      IMPLICIT NONE
C     
...
C     Amplitude(s) for diagram number 6
      CALL FFV2C1_0(W(1,3),W(1,2),W(1,6),GC_79,AMP(6))
      CALL FFV1_1(W(1,5),W(1,7),GC_11,ZERO,ZERO,W(1,6))
