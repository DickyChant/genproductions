...
C     First try system wide (for cluster if define)
      ...
      TEMPNAME='/cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/lhapdf'
     $ //'/6.2.1-ghjeda2/share/LHAPDF'//TABLEFILE
      OPEN(IU,FILE=TEMPNAME,STATUS='old',ERR=1)
      RETURN
 1    TEMPNAME='/cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/lhapdf'
     $ //'/6.2.1-ghjeda2/share/LHAPDF/Pdfdata/'//TABLEFILE
      OPEN(IU,FILE=TEMPNAME,STATUS='old',ERR=2)
      RETURN
 2    TEMPNAME='/cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/lhapdf'
     $ //'/6.2.1-ghjeda2/share/LHAPDF/lhapdf'//TABLEFILE
      OPEN(IU,FILE=TEMPNAME,STATUS='old',ERR=3)
      RETURN
 3    TEMPNAME='/cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/lhapdf'
     $ //'/6.2.1-ghjeda2/share/LHAPDF/../lhapdf/pdfsets/'//TABLEFILE
      OPEN(IU,FILE=TEMPNAME,STATUS='old',ERR=4)
      RETURN
 4    TEMPNAME='/cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/lhapdf'
     $ //'/6.2.1-ghjeda2/share/LHAPDF/../lhapdf/pdfsets/6.1/'/
     $ /TABLEFILE
