...
C     
C     Process: g u > mu+ mu+ d d u~ QCD<=1 QED<=4 WEIGHTED<=9 [ all =
C      QCD ] $$ w+ w- / n2 n3
C     Process: g c > mu+ mu+ s s c~ QCD<=1 QED<=4 WEIGHTED<=9 [ all =
C      QCD ] $$ w+ w- / n2 n3
C     
      IMPLICIT NONE
C     
...
C     
      DATA DENOM(1)/1/
      DATA (CF(I,  1),I=  1,  2) /   12,    4/
C     1 T(1,5,7) T(6,2)
      DATA DENOM(2)/1/
      DATA (CF(I,  2),I=  1,  2) /    4,   12/
C     1 T(1,6,7) T(5,2)
C     ----------
C     BEGIN CODE
C     ----------
      ...
      CALL FFV1_1(W(1,5),W(1,1),GC_11,ZERO,ZERO,W(1,8))
      CALL FFV2_3(W(1,2),W(1,6),GC_24,MDL_MW,MDL_WW,W(1,9))
      CALL FFV2_3(W(1,7),W(1,8),GC_24,MDL_MW,MDL_WW,W(1,10))
      CALL FFV2C1_1(W(1,3),W(1,9),GC_79,MDL_MN1,MDL_WN1,W(1,8))
C     Amplitude(s) for diagram number 1
      CALL FFV2_0(W(1,4),W(1,8),W(1,10),GC_79,AMP(1))
      CALL FFV2_2(W(1,4),W(1,9),GC_79,MDL_MN1,MDL_WN1,W(1,11))
C     Amplitude(s) for diagram number 2
      CALL FFV2C1_0(W(1,11),W(1,3),W(1,10),GC_79,AMP(2))
      CALL FFV1_1(W(1,6),W(1,1),GC_11,ZERO,ZERO,W(1,10))
      CALL FFV2_3(W(1,2),W(1,5),GC_24,MDL_MW,MDL_WW,W(1,9))
      CALL FFV2_3(W(1,7),W(1,10),GC_24,MDL_MW,MDL_WW,W(1,2))
      CALL FFV2C1_1(W(1,3),W(1,9),GC_79,MDL_MN1,MDL_WN1,W(1,10))
C     Amplitude(s) for diagram number 3
      CALL FFV2_0(W(1,4),W(1,10),W(1,2),GC_79,AMP(3))
      CALL FFV2_2(W(1,4),W(1,9),GC_79,MDL_MN1,MDL_WN1,W(1,12))
C     Amplitude(s) for diagram number 4
      CALL FFV2C1_0(W(1,12),W(1,3),W(1,2),GC_79,AMP(4))
      CALL FFV1_2(W(1,7),W(1,1),GC_11,ZERO,ZERO,W(1,2))
      CALL FFV2_3(W(1,2),W(1,6),GC_24,MDL_MW,MDL_WW,W(1,7))
C     Amplitude(s) for diagram number 5
      CALL FFV2_0(W(1,4),W(1,10),W(1,7),GC_79,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL FFV2C1_0(W(1,12),W(1,3),W(1,7),GC_79,AMP(6))
      CALL FFV2_3(W(1,2),W(1,5),GC_24,MDL_MW,MDL_WW,W(1,7))
C     Amplitude(s) for diagram number 7
      CALL FFV2_0(W(1,4),W(1,8),W(1,7),GC_79,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV2C1_0(W(1,11),W(1,3),W(1,7),GC_79,AMP(8))
      JAMP(1)=-AMP(1)-AMP(2)-AMP(7)-AMP(8)
      JAMP(2)=+AMP(3)+AMP(4)+AMP(5)+AMP(6)
      MATRIX_2 = 0.D0
      DO I = 1, NCOLOR
        ZTEMP = (0.D0,0.D0)
        DO J = 1, NCOLOR
