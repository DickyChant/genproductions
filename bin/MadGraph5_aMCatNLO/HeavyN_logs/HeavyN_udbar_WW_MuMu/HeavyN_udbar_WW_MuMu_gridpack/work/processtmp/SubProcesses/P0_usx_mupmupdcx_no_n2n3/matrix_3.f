...
C     
C     Process: u g > mu+ mu+ d s c~ QCD<=1 QED<=4 WEIGHTED<=9 [ all =
C      QCD ] $$ w+ w- / n2 n3
C     Process: c g > mu+ mu+ s d u~ QCD<=1 QED<=4 WEIGHTED<=9 [ all =
C      QCD ] $$ w+ w- / n2 n3
C     
      IMPLICIT NONE
C     
...
C     Amplitude(s) for diagram number 1
      ...
      CALL FFV2_2(W(1,4),W(1,8),GC_79,MDL_MN1,MDL_WN1,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL FFV2C1_0(W(1,5),W(1,3),W(1,9),GC_79,AMP(2))
...
C     Amplitude(s) for diagram number 4
      CALL FFV2C1_0(W(1,5),W(1,3),W(1,7),GC_79,AMP(4))
