...
C     Coefficient construction for loop diagram with ID 3
      ...
      CALL MP_FFV1L3_2(PL(0,1),W(1,5),GC_11,ZERO,ZERO,PL(0,2),COEFS)
      CALL MP_UPDATE_WL_0_1(WL(1,0,1,1),4,COEFS,4,4,WL(1,0,1,2))
      CALL MP_FFV2L1_2(PL(0,2),W(1,11),GC_24,ZERO,ZERO,PL(0,3),COEFS)
...
C     Coefficient construction for loop diagram with ID 4
      CALL MP_FFV2L1_2(PL(0,2),W(1,12),GC_24,ZERO,ZERO,PL(0,4),COEFS)
...
C     Coefficient construction for loop diagram with ID 5
      CALL MP_FFV1L2P0_3(PL(0,0),W(1,1),GC_11,ZERO,ZERO,PL(0,5),COEFS)
      CALL MP_UPDATE_WL_0_0(WL(1,0,1,0),4,COEFS,4,4,WL(1,0,1,5))
      CALL MP_FFV1L3_1(PL(0,5),W(1,6),GC_11,ZERO,ZERO,PL(0,6),COEFS)
      CALL MP_UPDATE_WL_0_1(WL(1,0,1,5),4,COEFS,4,4,WL(1,0,1,6))
      CALL MP_FFV2L2_1(PL(0,6),W(1,14),GC_24,ZERO,ZERO,PL(0,7),COEFS)
...
C     Coefficient construction for loop diagram with ID 6
      CALL MP_FFV2L2_1(PL(0,6),W(1,16),GC_24,ZERO,ZERO,PL(0,8),COEFS)
