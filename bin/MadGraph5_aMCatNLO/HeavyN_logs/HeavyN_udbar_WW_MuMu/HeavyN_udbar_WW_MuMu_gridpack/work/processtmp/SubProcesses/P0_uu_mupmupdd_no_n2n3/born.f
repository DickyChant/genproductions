...
C     
C     Process: u u > mu+ mu+ d d QCD=0 QED<=4 [ all = QCD ] $$ w+ w- /
C      n2 n3
C     Process: c c > mu+ mu+ s s QCD=0 QED<=4 [ all = QCD ] $$ w+ w- /
C      n2 n3
C     
      IMPLICIT NONE
C     
...
C     
      ...
      DATA IDEN_VALUES /144, 144, 144, 144, 144/
      INTEGER IJ_VALUES(5)
      DATA IJ_VALUES /1, 2, 6, 1, 2/
C     
C     GLOBAL VARIABLES
C     
      DOUBLE PRECISION AMP2(4), JAMP2(0:2)
...
C           Amplitude(s) for diagram number 1
            ...
            CALL FFV2_2(W(1,4),W(1,7),GC_79,MDL_MN1,MDL_WN1,W(1,9))
C           Amplitude(s) for diagram number 2
            CALL FFV2C1_0(W(1,9),W(1,3),W(1,8),GC_79,AMP(2))
            CALL FFV2_3(W(1,1),W(1,6),GC_24,MDL_MW,MDL_WW,W(1,9))
            CALL FFV2_3(W(1,2),W(1,5),GC_24,MDL_MW,MDL_WW,W(1,6))
            CALL FFV2C1_1(W(1,3),W(1,9),GC_79,MDL_MN1,MDL_WN1,W(1,5))
C           Amplitude(s) for diagram number 3
            CALL FFV2_0(W(1,4),W(1,5),W(1,6),GC_79,AMP(3))
            CALL FFV2_2(W(1,4),W(1,9),GC_79,MDL_MN1,MDL_WN1,W(1,5))
C           Amplitude(s) for diagram number 4
            CALL FFV2C1_0(W(1,5),W(1,3),W(1,6),GC_79,AMP(4))
            DO I=1,NGRAPHS
