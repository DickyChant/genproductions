...
C     
C     Process: g d~ > mu+ mu+ u~ d u~ QCD<=1 QED<=4 WEIGHTED<=9 [ all
C      = QCD ] $$ w+ w- / n2 n3
C     Process: g s~ > mu+ mu+ c~ s c~ QCD<=1 QED<=4 WEIGHTED<=9 [ all
C      = QCD ] $$ w+ w- / n2 n3
C     
      IMPLICIT NONE
C     
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV2C1_1(W(1,3),W(1,9),GC_79,MDL_MN1,MDL_WN1,W(1,12))
C     Amplitude(s) for diagram number 3
      CALL FFV2_0(W(1,4),W(1,12),W(1,2),GC_79,AMP(3))
      CALL FFV2_2(W(1,4),W(1,9),GC_79,MDL_MN1,MDL_WN1,W(1,13))
C     Amplitude(s) for diagram number 4
      CALL FFV2C1_0(W(1,13),W(1,3),W(1,2),GC_79,AMP(4))
      CALL FFV2_3(W(1,5),W(1,10),GC_24,MDL_MW,MDL_WW,W(1,2))
C     Amplitude(s) for diagram number 5
      CALL FFV2_0(W(1,4),W(1,8),W(1,2),GC_79,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL FFV2C1_0(W(1,11),W(1,3),W(1,2),GC_79,AMP(6))
      CALL FFV1_2(W(1,7),W(1,1),GC_11,ZERO,ZERO,W(1,2))
      CALL FFV2_3(W(1,2),W(1,6),GC_24,MDL_MW,MDL_WW,W(1,7))
C     Amplitude(s) for diagram number 7
      CALL FFV2_0(W(1,4),W(1,12),W(1,7),GC_79,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV2C1_0(W(1,13),W(1,3),W(1,7),GC_79,AMP(8))
