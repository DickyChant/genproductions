...
C     
C     Process: g s~ > mu+ mu+ d c~ u~ QCD<=1 QED<=4 WEIGHTED<=9 [ all
C      = QCD ] $$ w+ w- / n2 n3
C     Process: g d~ > mu+ mu+ s u~ c~ QCD<=1 QED<=4 WEIGHTED<=9 [ all
C      = QCD ] $$ w+ w- / n2 n3
C     
      IMPLICIT NONE
C     
