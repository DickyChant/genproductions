...
C     
C     Process: d~ d~ > mu+ mu+ u~ u~ QCD=0 QED<=4 [ all = QCD ] $$ w+
C      w- / n2 n3
C     Process: s~ s~ > mu+ mu+ c~ c~ QCD=0 QED<=4 [ all = QCD ] $$ w+
C      w- / n2 n3
C     
      IMPLICIT NONE
C     
...
C           Amplitude(s) for diagram number 2
            ...
            CALL FFV2_3(W(1,6),W(1,1),GC_24,MDL_MW,MDL_WW,W(1,9))
            CALL FFV2_3(W(1,5),W(1,2),GC_24,MDL_MW,MDL_WW,W(1,6))
