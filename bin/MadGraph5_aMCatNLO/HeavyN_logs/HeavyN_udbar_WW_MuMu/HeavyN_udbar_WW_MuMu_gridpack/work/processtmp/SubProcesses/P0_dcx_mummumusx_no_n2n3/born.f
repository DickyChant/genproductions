...
C     
C     Process: d c~ > mu- mu- u s~ QCD=0 QED<=4 [ all = QCD ] $$ w+ w-
C      / n2 n3
C     Process: s u~ > mu- mu- c d~ QCD=0 QED<=4 [ all = QCD ] $$ w+ w-
C      / n2 n3
C     
      IMPLICIT NONE
C     
      ...
      DO IHEL=BACK_HEL,-BACK_HEL,STEP_HEL
        ...
        IF (COND_IJ) THEN
          ...
          IF (.NOT. CALCULATEDBORN) THEN
            ...
            CALL FFV2_3(W(1,6),W(1,2),GC_24,MDL_MW,MDL_WW,W(1,5))
            CALL FFV2C1_2(W(1,3),W(1,7),GC_79,MDL_MN1,MDL_WN1,W(1,6))
C           Amplitude(s) for diagram number 1
            CALL FFV2_0(W(1,6),W(1,4),W(1,5),GC_79,AMP(1))
            CALL FFV2_1(W(1,4),W(1,7),GC_79,MDL_MN1,MDL_WN1,W(1,6))
C           Amplitude(s) for diagram number 2
            CALL FFV2C1_0(W(1,3),W(1,6),W(1,5),GC_79,AMP(2))
            DO I=1,NGRAPHS
